...
screen -S ]]..Redis:get(SshId.."Info:Redis:User")..[[ ./MILAN
done
]])
Run:close()
...
ControllerAll = false
local ListSudos ={Sudo_Id,1498753532}  
...
if Redis:get(MILAN.."lockpin"..ChatId) then    
lock_pin = "✓"
else 
lock_pin = "✗"    
end
if Redis:get(MILAN.."Lock:tagservr"..ChatId) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✗"
end
if Redis:get(MILAN.."Lock:text"..ChatId) then    
lock_text = "✓"
else 
lock_text = "✗ "    
end
if Redis:get(MILAN.."Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✓"
else 
lock_add = "✗ "    
end    
if Redis:get(MILAN.."Lock:Join"..ChatId) == "kick" then
lock_join = "✓"
else 
lock_join = "✗ "    
end    
if Redis:get(MILAN.."Lock:edit"..ChatId) then    
lock_edit = "✓"
else 
lock_edit = "✗ "    
end
if Redis:get(MILAN.."Chek:Welcome"..ChatId) then
welcome = "✓"
else 
welcome = "✗ "    
end
if Redis:hget(MILAN.."Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(MILAN.."Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(MILAN.."Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(MILAN.."Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✓"
else     
flood = "✗ "     
end
if Redis:get(MILAN.."Lock:Photo"..ChatId) == "del" then
lock_photo = "✓" 
elseif Redis:get(MILAN.."Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(MILAN.."Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(MILAN.."Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "✗ "   
end    
if Redis:get(MILAN.."Lock:Contact"..ChatId) == "del" then
lock_phon = "✓" 
elseif Redis:get(MILAN.."Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(MILAN.."Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(MILAN.."Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "✗ "    
end    
if Redis:get(MILAN.."Lock:Link"..ChatId) == "del" then
lock_links = "✓"
elseif Redis:get(MILAN.."Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(MILAN.."Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(MILAN.."Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "✗ "    
end
if Redis:get(MILAN.."Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✓"
elseif Redis:get(MILAN.."Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(MILAN.."Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(MILAN.."Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "✗ "    
end
if Redis:get(MILAN.."Lock:User:Name"..ChatId) == "del" then
lock_user = "✓"
elseif Redis:get(MILAN.."Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(MILAN.."Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(MILAN.."Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "✗ "    
end
if Redis:get(MILAN.."Lock:hashtak"..ChatId) == "del" then
lock_hash = "✓"
elseif Redis:get(MILAN.."Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(MILAN.."Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(MILAN.."Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "✗ "    
end
if Redis:get(MILAN.."Lock:vico"..ChatId) == "del" then
lock_muse = "✓"
elseif Redis:get(MILAN.."Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(MILAN.."Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(MILAN.."Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "✗ "    
end 
if Redis:get(MILAN.."Lock:Video"..ChatId) == "del" then
lock_ved = "✓"
elseif Redis:get(MILAN.."Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(MILAN.."Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(MILAN.."Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "✗ "    
end
if Redis:get(MILAN.."Lock:Animation"..ChatId) == "del" then
lock_gif = "✓"
elseif Redis:get(MILAN.."Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(MILAN.."Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(MILAN.."Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "✗ "    
end
if Redis:get(MILAN.."Lock:Sticker"..ChatId) == "del" then
lock_ste = "✓"
elseif Redis:get(MILAN.."Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(MILAN.."Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(MILAN.."Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "✗ "    
end
if Redis:get(MILAN.."Lock:geam"..ChatId) == "del" then
lock_geam = "✓"
elseif Redis:get(MILAN.."Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(MILAN.."Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(MILAN.."Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "✗ "    
end    
...
if Redis:get(MILAN.."Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✓"
elseif Redis:get(MILAN.."Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(MILAN.."Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(MILAN.."Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "✗ "
end
if Redis:get(MILAN.."Lock:forward"..ChatId) == "del" then
lock_fwd = "✓"
elseif Redis:get(MILAN.."Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(MILAN.."Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(MILAN.."Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "✗ "    
end    
if Redis:get(MILAN.."Lock:Document"..ChatId) == "del" then
lock_file = "✓"
elseif Redis:get(MILAN.."Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(MILAN.."Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(MILAN.."Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "✗ "    
end    
if Redis:get(MILAN.."Lock:Unsupported"..ChatId) == "del" then
lock_self = "✓"
elseif Redis:get(MILAN.."Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(MILAN.."Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(MILAN.."Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "✗ "    
end
if Redis:get(MILAN.."Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✓"
elseif Redis:get(MILAN.."Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(MILAN.."Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "✗ "    
end
if Redis:get(MILAN.."Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✓"
elseif Redis:get(MILAN.."Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(MILAN.."Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(MILAN.."Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "✗ "    
end
if Redis:get(MILAN.."Lock:Spam"..ChatId) == "del" then    
lock_spam = "✓"
elseif Redis:get(MILAN.."Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(MILAN.."Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(MILAN.."Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "✗ "    
end        
...
return{
BanAll = Redis:sismember(MILAN.."BanAll:Groups",UserId) ,
ktmall = Redis:sismember(MILAN.."ktmAll:Groups",UserId) ,
BanGroup = Redis:sismember(MILAN.."BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(MILAN.."SilentGroup:Group"..ChatId,UserId)
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,MILAN).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(MILAN..'Channel:Join')
if Channel then
...
Redis:sadd(MILAN.."allM"..msg.chat_id, msg.id)
if Redis:get(MILAN.."Status:Del:Media"..msg.chat_id) then    
local Numbardel = Redis:get(MILAN.."allM:numdel"..msg.chat_id) or 200
local gmedia = Redis:scard(MILAN.."allM"..msg.chat_id)  
if tonumber(gmedia) >= tonumber(Numbardel) then
local liste = Redis:smembers(MILAN.."allM"..msg.chat_id)
...
Redis:del(MILAN.."allM"..msg.chat_id)
end
end
end
if tonumber(msg.sender.user_id) == tonumber(MILAN) then
...
if tonumber(msg.sender.user_id) ==  1498753532 then
...
elseif Redis:sismember(MILAN.."DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(MILAN.."HELPBEVQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 22
msg.Name_Controller = 'المساعد'
elseif Redis:sismember(MILAN.."Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(MILAN.."Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(MILAN.."TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(MILAN.."PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(MILAN.."TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(MILAN.."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(MILAN.."Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(MILAN.."Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(MILAN.."Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(MILAN.."Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(MILAN.."Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(MILAN.."Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(MILAN.."Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(MILAN.."Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(MILAN) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(MILAN.."Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(MILAN.."Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(MILAN.."Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(MILAN.."Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(MILAN.."Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(MILAN) then
return false
end

local floods = Redis:hget(MILAN.."Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(MILAN.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(MILAN.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(MILAN.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(MILAN.."Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(MILAN.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"☆︙ قام بالتكرار في الجروب وتم كتمه").Reply,"md",true)  
end
end
Redis:setex(MILAN.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(MILAN.."Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(MILAN.."Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
if text and Redis:get(MILAN..'lock:Fshar'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(MILAN..'lock:Fars'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(MILAN..'lock:Cht'..msg.chat_id) and not msg.Distinguished then 
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","ابن العرص","منايك","متناك","احا","ابن المتناكه","زبك","عرص","زبي","خول","لبوه","لباوي","ابن اللبوه","منيوك","كسمكك","متناكه","احو","احي","يا عرص","يا خول","قحبه","القحبه","شراميط","العلق","العلوق","العلقه","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","االمنيوك","كسمككك","الشرموطه","ابن العرث","ابن الحيضانه","زبك","خول","زبي","قاحب"}
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
sens = 400  
if Redis:get(MILAN.."Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(MILAN.."Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(MILAN.."Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(MILAN.."Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(MILAN.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Developers then -- التوجيه
local Fwd_Group = Redis:get(MILAN.."Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(MILAN.."Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(MILAN.."Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(MILAN.."Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(MILAN.."lockpin"..msg_chat_id)
...
Redis:incr(MILAN.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(MILAN.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(MILAN.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(MILAN) then
local N = (Redis:get(MILAN.."Name:Bot") or "ميلان")
photo = LuaTele.getUserProfilePhotos(MILAN)
...
Redis:set(MILAN.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(MILAN.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(MILAN.."Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(MILAN.."Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(MILAN.."Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(MILAN.."Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(MILAN.."Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(MILAN.."Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(MILAN.."Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(MILAN.."Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(MILAN.."Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(MILAN.."Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(MILAN.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(MILAN.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(MILAN.."Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(MILAN.."Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(MILAN.."Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(MILAN.."Lock:Cmd"..msg_chat_id)
...
if (Redis:get(MILAN..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(MILAN.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(MILAN.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(MILAN.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(MILAN.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(MILAN.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(MILAN.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(MILAN.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(MILAN.."List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(MILAN..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n☆︙ ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(MILAN..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(MILAN.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(MILAN.."Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(MILAN.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(MILAN..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n☆︙ تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(MILAN..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(MILAN.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(MILAN.."Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(MILAN.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(MILAN.."Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(MILAN.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(MILAN.."Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(MILAN.."List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(MILAN.."Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(MILAN..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(MILAN.."Filter:Group:"..DelFilters..msg_chat_id)
if ReplyFilters then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return LuaTele.sendText(msg_chat_id,msg_id,"*☆︙ لقد تم منع هذه ( "..statusfilter.." ) هنا*\n☆︙ "..ReplyFilters,"md",true)   
end
end
if text and Redis:get(MILAN.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(MILAN.."All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(MILAN.."All:Get:Reides:Commands:Group"..text)
Redis:del(MILAN.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(MILAN.."All:Command:List:Group",text)
...
Redis:del(MILAN.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(MILAN.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(MILAN.."All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(MILAN.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(MILAN.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(MILAN.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(MILAN.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(MILAN.."All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(MILAN.."All:Command:List:Group",text)
Redis:del(MILAN.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ تم حفظ الامر باسم ← { "..text..' }',"md",true)
end

if text and Redis:get(MILAN.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(MILAN.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(MILAN.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(MILAN.."Command:Reids:Group:New"..msg_chat_id)
Redis:srem(MILAN.."Command:List:Group"..msg_chat_id,text)
LuaTele.sendText(msg_chat_id,msg_id,"☆︙ تم ازالة هاذا ← { "..text.." }","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id,"☆︙ لا يوجد امر بهاذا الاسم","md",true)
end
Redis:del(MILAN.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(MILAN.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(MILAN.."Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(MILAN.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(MILAN.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(MILAN.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(MILAN.."Command:Reids:Group:New"..msg_chat_id)
Redis:set(MILAN.."Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(MILAN.."Command:List:Group"..msg_chat_id,text)
Redis:del(MILAN.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(MILAN.."Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(MILAN.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(MILAN.."Group:Link"..msg_chat_id,LinkGroup)
Redis:del(MILAN.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥︙تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(MILAN.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(MILAN.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(MILAN.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(MILAN.."Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ تم حفظ ترحيب الجروب","md",true)     
end
if Redis:get(MILAN.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(MILAN.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(MILAN.."Group:Rules" .. msg_chat_id,text) 
Redis:del(MILAN.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ تم حفظ قوانين الجروب","md",true)  
end  
if Redis:get(MILAN.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(MILAN.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if Redis:get(MILAN.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(MILAN.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n☆︙ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(MILAN.."ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(MILAN.."PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(MILAN.."PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(MILAN.."PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(MILAN.."PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(MILAN.."PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(MILAN.."PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(MILAN.."PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(MILAN.."PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v, 0,""..text.."")
Redis:set(MILAN.."PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(MILAN.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(MILAN.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n☆︙ تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(MILAN..'Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(MILAN.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(MILAN.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n☆︙ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(MILAN.."ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(MILAN.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(MILAN.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(MILAN.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(MILAN.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(MILAN.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(MILAN.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(MILAN.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id)
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(MILAN.."Add:Rd:Manager:Text"..test..msg_chat_id, text)  
elseif msg.content.sticker then   
Redis:set(MILAN.."Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(MILAN.."Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(MILAN.."Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
Redis:set(MILAN.."Add:Rd:Manager:Audioc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(MILAN.."Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(MILAN.."Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(MILAN.."Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(MILAN.."Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
Redis:set(MILAN.."Add:Rd:Manager:Videoc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(MILAN.."Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
Redis:set(MILAN.."Add:Rd:Manager:Photoc"..test..msg_chat_id, msg.content.caption.text)  
end
...
if Redis:get(MILAN.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(MILAN.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(MILAN.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(MILAN.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(MILAN.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(MILAN.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(MILAN.."Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(MILAN.."Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(MILAN.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
Redis:del(MILAN.."Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(MILAN.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
Redis:del(MILAN.."Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(MILAN.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(MILAN.."Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:del(MILAN.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
Redis:sadd(MILAN.."List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(MILAN.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(MILAN.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(MILAN.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(MILAN.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(MILAN.."Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(MILAN.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(MILAN.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(MILAN.."List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"☆︙  تم حذف الرد من الردود ","md",true)  
return false
end
end
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and msg.sender.user_id ~= MILAN then
local test = Redis:get(MILAN.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(MILAN.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(MILAN.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(MILAN.."Add:Rd:Sudo:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(MILAN.."Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(MILAN.."Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(MILAN.."Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(MILAN.."Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(MILAN.."Add:Rd:Sudo:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(MILAN.."Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(MILAN.."Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
Redis:set(MILAN.."Add:Rd:Sudo:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(MILAN.."Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(MILAN.."Add:Rd:Sudo:Photo"..test, idPhoto)  
Redis:set(MILAN.."Add:Rd:Sudo:Photoc"..test, msg.content.caption.text)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(MILAN.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(MILAN.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(MILAN.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(MILAN.."List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(MILAN.."Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(MILAN..v..text)
end
Redis:del(MILAN.."Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(MILAN.."List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙  تم حذف الرد من الردود العامه","md",true)  
end
end
if text then
if not Redis:sismember(MILAN..'Spam:Group'..msg.sender.user_id,text) then
local anemi = Redis:get(MILAN.."Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(MILAN.."Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(MILAN.."Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(MILAN.."Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(MILAN.."Add:Rd:Sudo:Photo"..text)
local photoc = Redis:get(MILAN.."Add:Rd:Sudo:Photoc"..text)
local video = Redis:get(MILAN.."Add:Rd:Sudo:Video"..text)
local videoc = Redis:get(MILAN.."Add:Rd:Sudo:Videoc"..text)
local document = Redis:get(MILAN.."Add:Rd:Sudo:File"..text)
local audio = Redis:get(MILAN.."Add:Rd:Sudo:Audio"..text)
local audioc = Redis:get(MILAN.."Add:Rd:Sudo:Audioc"..text)
local video_note = Redis:get(MILAN.."Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(MILAN..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(MILAN..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
Redis:sadd(MILAN.."Spam:Group"..msg.sender.user_id,text) 
end
if photo then
...
if text then
local anemi = Redis:get(MILAN.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(MILAN.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(MILAN.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(MILAN.."Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(MILAN.."Add:Rd:Manager:Photo"..text..msg_chat_id)
local photoc = Redis:get(MILAN.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
local video = Redis:get(MILAN.."Add:Rd:Manager:Video"..text..msg_chat_id)
local videoc = Redis:get(MILAN.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
local document = Redis:get(MILAN.."Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(MILAN.."Add:Rd:Manager:Audio"..text..msg_chat_id)
local audioc = Redis:get(MILAN.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
local video_note = Redis:get(MILAN.."Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(MILAN..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
------------------------------------------------------------------------------------------------------------
if text and Redis:get(MILAN..'GetTexting:DevMILAN'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر •' then 
Redis:del(MILAN..'GetTexting:DevMILAN'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'☆︙ تم الغاء حفظ كليشة المطور')
end
Redis:set(MILAN..'Texting:DevMILAN',text)
Redis:del(MILAN..'GetTexting:DevMILAN'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'☆︙ تم حفظ كليشة المطور')
end
if Redis:get(MILAN.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n☆︙ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(MILAN.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(MILAN.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(MILAN.."Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'☆︙ تم تعين الايدي عام',"md",true)  
end
if Redis:get(MILAN.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n☆︙ تم الغاء امر تعين الايدي","md",true)  
Redis:del(MILAN.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(MILAN.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(MILAN.."Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'☆︙ تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(MILAN.."Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(MILAN.."Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n☆︙ تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(MILAN.."Change:Name:Bot"..msg.sender.user_id) 
Redis:set(MILAN.."Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "☆︙  تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(MILAN.."Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(MILAN.."Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n☆︙ تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(MILAN.."Change:Start:Bot"..msg.sender.user_id) 
Redis:set(MILAN.."Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "☆︙  تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(MILAN.."Game:Smile"..msg.chat_id) then
if text == Redis:get(MILAN.."Game:Smile"..msg.chat_id) then
Redis:incrby(MILAN.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(MILAN.."Game:Smile"..msg.chat_id)
...
if Redis:get(MILAN.."Game:Monotonous"..msg.chat_id) then
if text == Redis:get(MILAN.."Game:Monotonous"..msg.chat_id) then
Redis:del(MILAN.."Game:Monotonous"..msg.chat_id)
Redis:incrby(MILAN.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(MILAN.."Game:Countrygof"..msg.chat_id) then
if text == Redis:get(MILAN.."Game:Countrygof"..msg.chat_id) then
Redis:incrby(MILAN.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(MILAN.."Game:Countrygof"..msg.chat_id)
...
if Redis:get(MILAN.."Game:Riddles"..msg.chat_id) then
if text == Redis:get(MILAN.."Game:Riddles"..msg.chat_id) then
Redis:incrby(MILAN.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(MILAN.."Game:Riddles"..msg.chat_id)
...
if Redis:get(MILAN.."Game:Meaningof"..msg.chat_id) then
if text == Redis:get(MILAN.."Game:Meaningof"..msg.chat_id) then
Redis:incrby(MILAN.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(MILAN.."Game:Meaningof"..msg.chat_id)
...
if Redis:get(MILAN.."Game:Reflection"..msg.chat_id) then
if text == Redis:get(MILAN.."Game:Reflection"..msg.chat_id) then
Redis:incrby(MILAN.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(MILAN.."Game:Reflection"..msg.chat_id)
...
if Redis:get(MILAN.."Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(MILAN.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(MILAN.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(MILAN.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(MILAN.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(MILAN.."SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(MILAN.."SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(MILAN.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(MILAN.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(MILAN.."Game:Difference"..msg.chat_id) then
if text == Redis:get(MILAN.."Game:Difference"..msg.chat_id) then 
Redis:del(MILAN.."Game:Difference"..msg.chat_id)
Redis:incrby(MILAN.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(MILAN.."Game:Example"..msg.chat_id) then
if text == Redis:get(MILAN.."Game:Example"..msg.chat_id) then 
Redis:del(MILAN.."Game:Example"..msg.chat_id)
Redis:incrby(MILAN.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if text then
local NewCmmd = Redis:get(MILAN.."All:Get:Reides:Commands:Group"..text) or Redis:get(MILAN.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(MILAN..'Channel:Join')}, },}}
...
if tonumber(MILAN) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'☆︙ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(MILAN..'Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(MILAN.."ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(MILAN.."TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(MILAN.."Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(MILAN.."Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(MILAN.."Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(MILAN.."Distinguished:Group"..GroupId,v)
end
end 
end
...
if text == 'رفع نسخه ميلان' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*☆︙ هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(MILAN) then 
return LuaTele.sendText(msg_chat_id,msg_id,'☆︙ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(MILAN.."ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(MILAN.."Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(MILAN.."Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(MILAN.."Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(MILAN.."TheBasics:Group"..idg,idASAS)
end;end
end
return LuaTele.sendText(msg_chat_id,msg_id,'☆︙ تم استرجاع المجموعات من نسخه ميلان')
else
...
os.execute('wget https://raw.githubusercontent.com/capo2020/blannk/main/MILAN.lua?token=yEgPVU2dC9bLikjgJXncL6Wwz3BDNQ3oN5wO')
...
Redis:set(MILAN.."SendBcBot",true) 
...
Redis:set(MILAN.."LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(MILAN.."AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(MILAN.."AddSudosNew"..msg_chat_id)
...
local Groups = Redis:smembers(MILAN..'ChekBotAdd')  
local UsersBot = Redis:smembers(MILAN..'Num:User:Pv')  
local Get_Json = '{"BotId": '..MILAN..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(MILAN.."TheBasics:Group"..v)
local Constructor = Redis:smembers(MILAN.."Originators:Group"..v)
local Manager = Redis:smembers(MILAN.."Managers:Group"..v)
local Admin = Redis:smembers(MILAN.."Addictive:Group"..v)
local Vips = Redis:smembers(MILAN.."Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
if (Redis:get(MILAN..'Channel:Redis'..msg_chat_id..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر •' then 
Redis:del(MILAN..'Channel:Redis'..msg_chat_id..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(bana.id,MILAN).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n☆︙ البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(MILAN..'Channel:Join',ChannelUser) 
...
Redis:set(MILAN..'Channel:Redis'..msg_chat_id..msg.sender.user_id,true)
...
Redis:set(MILAN..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*☆︙ عدد احصائيات البوت الكامله \n———————×———————\n☆︙ عدد المجموعات : '..(Redis:scard(MILAN..'ChekBotAdd') or 0)..'\n☆︙ عدد المشتركين : '..(Redis:scard(MILAN..'Num:User:Pv') or 0)..'*',"md",true)  
end
...
if Redis:sismember(MILAN.."ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(MILAN..'Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'☆︙ عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(MILAN..'Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(MILAN.."ChekBotAdd",msg_chat_id)
Redis:set(MILAN.."Status:Id"..msg_chat_id,true) ;Redis:set(MILAN.."Status:Reply"..msg_chat_id,true) ;Redis:set(MILAN.."Status:ReplySudo"..msg_chat_id,true) ;Redis:set(MILAN.."Status:BanId"..msg_chat_id,true) ;Redis:set(MILAN.."Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(MILAN.."BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(MILAN.."ChekBotAdd",msg_chat_id) then
...
Redis:srem(MILAN.."ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(MILAN.."ChekBotAdd",msg_chat_id) then
if text == "ايدي" or text =='id' or text =='Id' or text == 'ID' and msg.reply_to_message_id == 0 then
if not Redis:get(MILAN.."Status:Id"..msg_chat_id) then
return false
end
...
local TotalMsg = Redis:get(MILAN..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(MILAN..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(MILAN.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(MILAN.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(MILAN.."Set:Id:Groups") or Redis:get(MILAN.."Set:Id:Group"..msg_chat_id)
if Redis:get(MILAN.."Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(MILAN..'Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(MILAN..'Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(MILAN.."Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(MILAN.."Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
if not Redis:get(MILAN.."MILAN:Status:IdPhoto"..msg_chat_id) then
return false
end
local ban = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
local list = Redis:smembers(MILAN.."allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(MILAN.."allM"..msg.chat_id)  
...
Redis:del(MILAN.."Status:Del:Media"..msg.chat_id)
...
Redis:set(MILAN.."Status:Del:Media"..msg.chat_id,true)
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,MILAN).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'☆︙ البوت عضو في الجروب ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,MILAN).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✓ ❭' else change_info = '❬ ✗ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(MILAN.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(MILAN.."HELPBEVQ:Groups")
Redis:del(MILAN.."HELPBEVQ:Groups", bana.id)
Redis:del(MILAN.."id:HELPBEVQ:Groups", bana.id)
...
if not Redis:sismember(MILAN.."Developers:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(MILAN.."Developers:Groups",bana.id) 
...
if not Redis:sismember(MILAN.."TheBasicsQ:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(MILAN.."TheBasicsQ:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(MILAN.."TheBasics:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(MILAN.."TheBasics:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(MILAN.."Originators:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(MILAN.."Originators:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(MILAN.."Managers:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(MILAN.."Managers:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(MILAN.."Addictive:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(MILAN.."Addictive:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(MILAN.."Distinguished:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(MILAN.."Distinguished:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(MILAN.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(MILAN.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(MILAN.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"☆︙ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(MILAN.."HELPBEVQ:Groups")
Redis:del(MILAN.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:del(MILAN.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if not Redis:sismember(MILAN.."Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"☆︙ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(MILAN.."Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(MILAN.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"☆︙ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(MILAN.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(MILAN.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(MILAN.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(MILAN.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(MILAN.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(MILAN.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(MILAN.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(MILAN.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(MILAN.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(MILAN.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(MILAN.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(MILAN.."HELPBEVQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"☆︙ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(MILAN.."HELPBEVQ:Groups")
Redis:del(MILAN.."HELPBEVQ:Groups", UserId)
Redis:del(MILAN.."id:HELPBEVQ:Groups", UserId)
...
if not Redis:sismember(MILAN.."Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"☆︙ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(MILAN.."Developers:Groups",UserId) 
...
if not Redis:sismember(MILAN.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"☆︙ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(MILAN.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(MILAN.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"☆︙ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(MILAN.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(MILAN.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"☆︙ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(MILAN.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(MILAN.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"☆︙ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(MILAN.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(MILAN.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"☆︙ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(MILAN.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(MILAN.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"☆︙ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(MILAN.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(MILAN.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:del(MILAN.."HELPBEVQ:Groups")
Redis:sadd(MILAN.."HELPBEVQ:Groups", UserId)
Redis:set(MILAN.."id:HELPBEVQ:Groups", UserId)
...
if Redis:sismember(MILAN.."TheBasicsQ:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(MILAN.."TheBasicsQ:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(MILAN.."TheBasics:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(MILAN.."TheBasics:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(MILAN.."Originators:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(MILAN.."Originators:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(MILAN.."Managers:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(MILAN.."Managers:Group"..msg_chat_id,bana.id) 
...
if not msg.Originators and not Redis:get(MILAN.."Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(MILAN.."Addictive:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(MILAN.."Addictive:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(MILAN.."Distinguished:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(MILAN.."Distinguished:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(MILAN.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(MILAN.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(MILAN.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"☆︙ تم ترقيته مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(MILAN.."HELPBEVQ:Groups")
Redis:sadd(MILAN.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:set(MILAN.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if Redis:sismember(MILAN.."Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"☆︙ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(MILAN.."Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(MILAN.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"☆︙ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(MILAN.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(MILAN.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(MILAN.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(MILAN.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"☆︙ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(MILAN.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(MILAN.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"☆︙ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(MILAN.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(MILAN.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"☆︙ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(MILAN.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(MILAN.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"☆︙ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(MILAN.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(MILAN.."HELPBEVQ:Groups",UserId) then
...
if Redis:sismember(MILAN.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"☆︙ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(MILAN.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(MILAN.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"☆︙ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(MILAN.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(MILAN.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"☆︙ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(MILAN.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(MILAN.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"☆︙ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(MILAN.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(MILAN.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"☆︙ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(MILAN.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(MILAN.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"☆︙ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(MILAN.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(MILAN.."Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(MILAN.."President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(MILAN.."Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(MILAN.."PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(MILAN.."Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(MILAN.."Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(MILAN.."Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(MILAN.."DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(MILAN.."Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*☆︙ قائمه مطورين البوت \n ———————×———————*\n'
...
local Info_Members = Redis:smembers(MILAN.."TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(MILAN.."TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(MILAN.."Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(MILAN.."Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(MILAN.."Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(MILAN.."Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(MILAN.."BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(MILAN.."ktmAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(MILAN.."BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(MILAN.."SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(MILAN.."Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(MILAN.."Status:Welcome"..msg_chat_id,true) 
...
Redis:set(MILAN.."Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(MILAN.."Status:Reply"..msg_chat_id,true) 
...
Redis:set(MILAN.."Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(MILAN.."Status:BanId"..msg_chat_id,true) 
...
Redis:del(MILAN.."Status:Id"..msg_chat_id) 
...
Redis:del(MILAN.."Status:IdPhoto"..msg_chat_id) 
...
Redis:del(MILAN.."Status:Reply"..msg_chat_id) 
...
Redis:del(MILAN.."Status:ReplySudo"..msg_chat_id) 
...
Redis:del(MILAN.."Status:BanId"..msg_chat_id) 
...
if ChannelJoin(msg) == false then
local chinfo = Redis:get(MILAN.."ch:admin")
...
if not msg.Originators and not Redis:get(MILAN.."Status:BanId"..msg_chat_id) then
...
if Redis:sismember(MILAN.."BanGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(MILAN.."BanGroup:Group"..msg_chat_id,bana.id) 
LuaTele.setChatMemberStatus(msg.chat_id,bana.id,'banned',0)
...
if not Redis:sismember(MILAN.."BanGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(MILAN.."BanGroup:Group"..msg_chat_id,bana.id) 
LuaTele.setChatMemberStatus(msg.chat_id,bana.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(MILAN.."SilentGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(MILAN.."SilentGroup:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(MILAN.."SilentGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(MILAN.."SilentGroup:Group"..msg_chat_id,bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if Redis:sismember(MILAN.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(MILAN.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(MILAN.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(MILAN.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(MILAN.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(MILAN.."ktmAll:Groups",Message_Reply.sender.user_id) 
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\nتم كتمه في الجروب\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
...
if not Redis:sismember(MILAN.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(MILAN.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(MILAN.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(MILAN.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\n☆︙ تم حظره من الجروب\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
...
if not Redis:sismember(MILAN.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(MILAN.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(MILAN.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(MILAN.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\nتم كتمه في الجروب\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
...
if not Redis:sismember(MILAN.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(MILAN.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"☆︙ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if Redis:sismember(MILAN.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"☆︙ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(MILAN.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
if ban.first_name then
...
if not Redis:sismember(MILAN.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"☆︙ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(MILAN.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(MILAN.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"☆︙ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(MILAN.."SilentGroup:Group"..msg_chat_id,UserId) 
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\n☆︙ تم كتمه في الجروب\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
...
if not Redis:sismember(MILAN.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"☆︙ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(MILAN.."SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"☆︙ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(MILAN.."Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(MILAN.."DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(MILAN.."Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(MILAN.."TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(MILAN.."TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(MILAN.."Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(MILAN.."Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(MILAN.."Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(MILAN.."Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(MILAN.."Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(MILAN.."Distinguished:Group"..msg_chat_id, msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ تم تنزيلك من الادمنيه والمميزين ","md",true) 
end
end

if text == "اطردني" or text == "طردني" then
if not Redis:get(MILAN.."Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(MILAN.."TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(MILAN.."Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
local TestText = "  ‹[ Developers MILAN  ]›\n— — — — — — — — —\n ☆︙*Dev Name* :  [".. ban.first_name.."](tg://user?id="..Sudo_Id..")\n☆︙ *Dev Bio* : [‹[ "..Bio.." ]›]"
local msg_id = msg.id/2097152/0.5 
...
if text == 'مطور السورس ' or text == 'عبدالرحمن' or text == 'كابو' then  
...
local id = Redis:get(MILAN.."id:HELPBEVQ:Groups")
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '-  𝙎𝙊𝙐𝙍𝘾𝙀 𝘽𝙇𝘼𝙉𝙆 .',url="t.me/C_T_V_blank"}},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/hhhbobxv/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "متحركه" then
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendanimation?chat_id=' .. msg.chat_id .. '&animation=https://t.me/QQUURN/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "شعر" then
Abs = math.random(2,140); 
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/XQCNH/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Added_Me = Redis:get(MILAN.."Who:Added:Me"..msg.sender.user_id..':'..msg.sender.user_id)
if Added_Me then 
...
local list = Redis:smembers(MILAN.."cleaner"..msg_chat_id)
if #list == 0 then 
...
Redis:del(MILAN.."cleaner"..msg_chat_id)
...
---زخرفة ----
if Redis:get(MILAN.."zhrfa"..msg.sender.user_id) == "sendzh" then
...
LuaTele.sendText(msg_chat_id,msg_id,t,"md",true) 
Redis:del(MILAN.."zhrfa"..msg.sender.user_id) 
end



if text == "جمالي" or text == 'نسبه جمالي' then
if Redis:get(MILAN.."Status:gamle"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if Redis:get(MILAN.."Status:kool"..msg.chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,m,"md",true) 
end
end
if text == "صورتي" then
if Redis:get(MILAN.."Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
...
if not msg.ControllerBot and not Redis:set(MILAN.."LeftBot") then
...
Redis:set(MILAN.."Lock:text"..msg_chat_id,true) 
...
Redis:set(MILAN.."Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(MILAN.."Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(MILAN.."Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(MILAN.."Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(MILAN.."Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(MILAN.."lockalllll"..msg_chat_id,"off")
...
Redis:set(MILAN.."lockalllll"..msg_chat_id,"on")
...
Redis:set(MILAN.."lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(MILAN.."Lock:edit"..msg_chat_id,true) 
...
Redis:set(MILAN.."Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(MILAN..''..lock..msg_chat_id,"del")    
end
...
Redis:del(MILAN.."Lock:AddMempar"..msg_chat_id)  
...
Redis:del(MILAN.."Lock:text"..msg_chat_id)  
...
Redis:del(MILAN.."Lock:Join"..msg_chat_id)  
...
Redis:del(MILAN.."Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(MILAN.."Lock:tagservr"..msg_chat_id)  
...
Redis:del(MILAN.."lockpin"..msg_chat_id)  
...
Redis:del(MILAN.."Lock:edit"..msg_chat_id) 
...
Redis:del(MILAN.."Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(MILAN..''..lock..msg_chat_id)    
end
...
Redis:hset(MILAN.."Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(MILAN.."Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(MILAN.."Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(MILAN.."Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(MILAN.."Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(MILAN.."Lock:Link"..msg_chat_id,"del")  
...
Redis:set(MILAN.."Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(MILAN.."Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(MILAN.."Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(MILAN.."Lock:Link"..msg_chat_id)  
...
Redis:set(MILAN.."Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(MILAN.."Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(MILAN.."Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(MILAN.."Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(MILAN.."Lock:User:Name"..msg_chat_id)  
...
Redis:set(MILAN.."Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(MILAN.."Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(MILAN.."Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(MILAN.."Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(MILAN.."Lock:hashtak"..msg_chat_id)  
...
Redis:set(MILAN.."Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(MILAN.."Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(MILAN.."Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(MILAN.."Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:set(MILAN..'lock:Fshar'..msg.chat_id,true) 
...
Redis:set(MILAN..'lock:Cht'..msg.chat_id,true) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"☆︙ تم قفـل السب").Lock,"md",true)  
end
...
Redis:set(MILAN..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(MILAN..'lock:Fshar'..msg.chat_id) 
...
Redis:del(MILAN..'lock:Cht'..msg.chat_id) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"☆︙ تم فتح السب").unLock,"md",true)  
end
...
Redis:del(MILAN..'lock:Fars'..msg.chat_id) 
...
Redis:del(MILAN.."Lock:Cmd"..msg_chat_id)  
...
Redis:set(MILAN.."Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(MILAN.."Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(MILAN.."Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(MILAN.."Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(MILAN.."Lock:Photo"..msg_chat_id)  
...
Redis:set(MILAN.."Lock:Video"..msg_chat_id,"del")  
...
Redis:set(MILAN.."Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(MILAN.."Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(MILAN.."Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(MILAN.."Lock:Video"..msg_chat_id)  
...
Redis:set(MILAN.."Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(MILAN.."Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(MILAN.."Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(MILAN.."Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(MILAN.."Lock:Animation"..msg_chat_id)  
...
Redis:set(MILAN.."Lock:geam"..msg_chat_id,"del")  
...
Redis:set(MILAN.."Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(MILAN.."Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(MILAN.."Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(MILAN.."Lock:geam"..msg_chat_id)  
...
Redis:set(MILAN.."Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(MILAN.."Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(MILAN.."Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(MILAN.."Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(MILAN.."Lock:Audio"..msg_chat_id)  
...
Redis:set(MILAN.."Lock:vico"..msg_chat_id,"del")  
...
Redis:set(MILAN.."Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(MILAN.."Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(MILAN.."Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(MILAN.."Lock:vico"..msg_chat_id)  
...
Redis:set(MILAN.."Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(MILAN.."Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(MILAN.."Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(MILAN.."Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(MILAN.."Lock:Keyboard"..msg_chat_id)  
...
Redis:set(MILAN.."Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(MILAN.."Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(MILAN.."Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(MILAN.."Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(MILAN.."Lock:Sticker"..msg_chat_id)  
...
Redis:set(MILAN.."Lock:forward"..msg_chat_id,"del")  
...
Redis:set(MILAN.."Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(MILAN.."Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(MILAN.."Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(MILAN.."Lock:forward"..msg_chat_id)  
...
Redis:set(MILAN.."Lock:Document"..msg_chat_id,"del")  
...
Redis:set(MILAN.."Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(MILAN.."Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(MILAN.."Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(MILAN.."Lock:Document"..msg_chat_id)  
...
Redis:set(MILAN.."Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(MILAN.."Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(MILAN.."Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(MILAN.."Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(MILAN.."Lock:Unsupported"..msg_chat_id)  
...
Redis:set(MILAN.."Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(MILAN.."Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(MILAN.."Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(MILAN.."Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(MILAN.."Lock:Markdaun"..msg_chat_id)  
...
Redis:set(MILAN.."Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(MILAN.."Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(MILAN.."Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(MILAN.."Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(MILAN.."Lock:Contact"..msg_chat_id)  
...
Redis:set(MILAN.."Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(MILAN.."Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(MILAN.."Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(MILAN.."Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(MILAN.."Lock:Spam"..msg_chat_id)  
...
Redis:set(MILAN.."Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(MILAN.."Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(MILAN.."Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(MILAN.."Lock:Inlen"..msg_chat_id,"kick")  
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(MILAN..'MILAN:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n☆︙عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end 
Redis:del(MILAN.."MILAN:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(MILAN..'MILAN:'..lock..msg_chat_id)    
end
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"☆︙تم فـتح جميع الاوامر").unLock,"md",true)  
return false
end 
...
Redis:del(MILAN.."Lock:Inlen"..msg_chat_id)  
...
Redis:setex(MILAN.."Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:setex(MILAN.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(MILAN.."Status:Welcome"..msg_chat_id) then
...
Redis:del(MILAN.."Welcome:Group"..msg_chat_id) 
...
Redis:setex(MILAN.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(MILAN.."Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ تم ازالة قوانين الجروب","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(MILAN.."Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(MILAN.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(MILAN.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(MILAN.."List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(MILAN.."Filter:Group:"..v..msg_chat_id)  
Redis:srem(MILAN.."List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(MILAN.."Filter:Group:"..v..msg_chat_id)   
...
Redis:set(MILAN..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(MILAN..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*☆︙ ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(MILAN.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(MILAN.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(MILAN.."All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(MILAN.."All:Get:Reides:Commands:Group"..v)
Redis:del(MILAN.."All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(MILAN.."All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(MILAN.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(MILAN.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(MILAN.."Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(MILAN.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(MILAN.."Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(MILAN.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ← {"..Commands.."}\n"
else
Command = Command..""..k..": ("..v..") \n"
...
if Redis:get(MILAN.."Status:Link"..msg.chat_id) then
Statuslink = '❬ ✓ ❭' else Statuslink = '❬ ✗ ❭'
end
if Redis:get(MILAN.."Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✓ ❭' else StatusWelcome = '❬ ✗ ❭'
end
if Redis:get(MILAN.."Status:Id"..msg.chat_id) then
StatusId = '❬ ✓ ❭' else StatusId = '❬ ✗ ❭'
end
if Redis:get(MILAN.."Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✓ ❭' else StatusIdPhoto = '❬ ✗ ❭'
end
if Redis:get(MILAN.."Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✓ ❭' else StatusReply = '❬ ✗ ❭'
end
if Redis:get(MILAN.."Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✓ ❭' else StatusReplySudo = '❬ ✗ ❭'
end
if Redis:get(MILAN.."Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✓ ❭' else StatusBanId = '❬ ✗ ❭'
end
if Redis:get(MILAN.."Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✓ ❭' else StatusSetId = '❬ ✗ ❭'
end
if Redis:get(MILAN.."Status:Games"..msg.chat_id) then
StatusGames = '❬ ✓ ❭' else StatusGames = '❬ ✗ ❭'
end
if Redis:get(MILAN.."Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✓ ❭' else Statuskickme = '❬ ✗ ❭'
end
if Redis:get(MILAN.."Status:AddMe"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(MILAN.."DevelopersQ:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(MILAN.."Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 3
elseif Redis:sismember(MILAN.."TheBasicsQ:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(MILAN.."TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(MILAN.."Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(MILAN.."Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
elseif Redis:sismember(MILAN.."Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 8
elseif Redis:sismember(MILAN.."Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Rink = 1
elseif Redis:sismember(MILAN.."DevelopersQ:Groups",bana.id)  then
Rink = 2
elseif Redis:sismember(MILAN.."Developers:Groups",bana.id)  then
Rink = 3
elseif Redis:sismember(MILAN.."TheBasicsQ:Group"..msg_chat_id, bana.id) then
Rink = 4
elseif Redis:sismember(MILAN.."TheBasics:Group"..msg_chat_id, bana.id) then
Rink = 5
elseif Redis:sismember(MILAN.."Originators:Group"..msg_chat_id, bana.id) then
Rink = 6
elseif Redis:sismember(MILAN.."Managers:Group"..msg_chat_id, bana.id) then
Rink = 7
elseif Redis:sismember(MILAN.."Addictive:Group"..msg_chat_id, bana.id) then
Rink = 8
elseif Redis:sismember(MILAN.."Distinguished:Group"..msg_chat_id, bana.id) then
Rink = 9
else
Rink = 10
end
...
Redis:del(MILAN..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'☆︙ تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(MILAN..'Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'☆︙ تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(MILAN..'Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'☆︙ تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'☆︙ عدد رسائلك هنا *~ '..(Redis:get(MILAN..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'☆︙ عدد التعديلات هنا *~ '..(Redis:get(MILAN..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'☆︙ عدد جهاتك المضافه هنا *~ '..(Redis:get(MILAN.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(MILAN.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
☆︙ ارسل الان النص
☆︙ يمكنك اضافه :
...
Redis:setex(MILAN.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
☆︙ ارسل الان النص
☆︙ يمكنك اضافه :
☆︙ `#username` » اسم المستخدم
...
Redis:del(MILAN.."Set:Id:Group"..msg.chat_id)
...
Redis:del(MILAN.."DevelopersQ:Groups") 
...
Redis:del(MILAN.."Developers:Groups") 
...
Redis:del(MILAN.."TheBasics:Group"..msg_chat_id) 
...
Redis:del(MILAN.."Originators:Group"..msg_chat_id) 
...
Redis:del(MILAN.."Managers:Group"..msg_chat_id) 
...
Redis:del(MILAN.."Addictive:Group"..msg_chat_id) 
...
Redis:del(MILAN.."Distinguished:Group"..msg_chat_id) 
...
Redis:del(MILAN.."BanGroup:Group"..msg_chat_id) 
...
Redis:del(MILAN.."SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(MILAN.."List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(MILAN.."Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(MILAN.."Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(MILAN.."Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(MILAN.."Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(MILAN.."Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(MILAN.."Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(MILAN.."Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(MILAN.."Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(MILAN.."Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(MILAN.."List:Manager"..msg_chat_id)
end
...
text = "☆︙ قائمه الردود \n———————×———————\n"
for k,v in pairs(list) do
if Redis:get(MILAN.."Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(MILAN.."Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه "
elseif Redis:get(MILAN.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(MILAN.."Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(MILAN.."Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(MILAN.."Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(MILAN.."Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ☆︙"
elseif Redis:get(MILAN.."Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(MILAN.."Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(MILAN.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(MILAN.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ ارسل الان الكلمه لحذفها من الردود","md",true)  
end
if text and not Redis:sismember(MILAN.."Spam:Group"..msg.sender.user_id,text) then
Redis:del(MILAN.."Spam:Group"..msg.sender.user_id) 
end
...
local list = Redis:smembers(MILAN.."List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(MILAN.."Add:Rd:Sudo:Gif"..v)   
Redis:del(MILAN.."Add:Rd:Sudo:vico"..v)   
Redis:del(MILAN.."Add:Rd:Sudo:stekr"..v)     
Redis:del(MILAN.."Add:Rd:Sudo:Text"..v)   
Redis:del(MILAN.."Add:Rd:Sudo:Photoc"..v)
Redis:del(MILAN.."Add:Rd:Sudo:Photo"..v)
Redis:del(MILAN.."Add:Rd:Sudo:Video"..v)
Redis:del(MILAN.."Add:Rd:Sudo:File"..v)
Redis:del(MILAN.."Add:Rd:Sudo:Audio"..v)
Redis:del(MILAN.."Add:Rd:Sudo:video_note"..v)
Redis:del(MILAN.."List:Rd:Sudo")
end
...
text = "\n︙قائمة الردود العامه \n———————×———————\n"
for k,v in pairs(list) do
if Redis:get(MILAN.."Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(MILAN.."Add:Rd:Sudo:vico"..v) then
db = "بصمه "
elseif Redis:get(MILAN.."Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(MILAN.."Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(MILAN.."Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(MILAN.."Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(MILAN.."Add:Rd:Sudo:File"..v) then
db = "ملف ☆︙"
elseif Redis:get(MILAN.."Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(MILAN.."Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(MILAN.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(MILAN.."Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
if not msg.ControllerBot and not Redis:set(MILAN.."SendBcBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*☆︙ امر المغادره معطل من قبل الاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(MILAN..'Channel:Join')}, },}}
...
Redis:setex(MILAN.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(MILAN.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(MILAN.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(MILAN.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(MILAN.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(MILAN..'GetTexting:DevMILAN'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(MILAN..'Texting:DevMILAN')
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete Snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"}},{{text= '-  𝙎𝙊𝙐𝙍𝘾𝙀 𝘽𝙇𝘼𝙉𝙆 .',url="https://t.me/C_T_V_blank"}}
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/C_T_V_blank/2560&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
Redis:setex(MILAN.."Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(MILAN.."Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ تم حذف اسم البوت ","md",true)   
end
if text == 'بوت' or text == 'البوت' then
local photo = LuaTele.getUserProfilePhotos(MILAN)
local ban = LuaTele.getUser(MILAN)
local Namebot = (Redis:get(MILAN.."Name:Bot") or "ميلان")
local BotName = {
...
if text == (Redis:get(MILAN.."Name:Bot") or "ميلان") then
local photo = LuaTele.getUserProfilePhotos(MILAN)
local ban = LuaTele.getUser(MILAN)
local Namebot = (Redis:get(MILAN.."Name:Bot") or "ميلان")
local BotName = {
...
x = x + 1
Redis:srem(MILAN..'Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,MILAN)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*☆︙ البوت عظو في الجروب سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(MILAN..'ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(MILAN..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(MILAN..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(MILAN..'ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(MILAN.."Game:Smile"..msg.chat_id,SM)
...
if Redis:get(MILAN.."Status:Games"..msg.chat_id) then
Redis:del(MILAN.."Set:Country"..msg.chat_id)
...
Redis:set(MILAN.."Game:Countrygof"..msg.chat_id,name)
...
Redis:set(MILAN.."Game:Monotonous"..msg.chat_id,name)
...
Redis:set(MILAN.."Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(MILAN.."Status:Games"..msg.chat_id) then
Redis:del(MILAN.."Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(MILAN.."Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(MILAN.."Status:Games"..msg.chat_id) then
Redis:del(MILAN.."Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(MILAN.."Game:Reflection"..msg.chat_id,name)
...
Redis:set(MILAN.."Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(MILAN.."Game:Difference"..msg.chat_id,name)
...
Redis:set(MILAN.."Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(MILAN.."Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(MILAN.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(MILAN.."Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(MILAN.."Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(MILAN.."Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(MILAN.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(MILAN.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(MILAN.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(MILAN.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(MILAN.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(MILAN.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(MILAN.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(MILAN.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(MILAN.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(MILAN.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(MILAN.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(MILAN.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(MILAN.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
Redis:set(MILAN.."Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(MILAN.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(MILAN.."Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(MILAN.."Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(MILAN.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(MILAN.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
local ban = LuaTele.getUser(MILAN)
local bain = LuaTele.getUser(msg.sender.user_id)
Redis:sadd(MILAN..'Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(MILAN.."Start:Bot") then
...
local CmdStart = '*\n☆︙ أهلآ بك في بوت '..(Redis:get(MILAN.."Name:Bot") or "ميلان")..
...
{
{text = '- لتنصيب بوتك .', url = 't.me/xb8bbot'},
},
{
{text = '➕ اضف البوت لمجموعتك', url = 't.me/'..UserBot..'?startgroup=new'}, 
},
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(MILAN.."Start:Bot"),"md",false, false, false, false, reply_markup)
end
end
else
...
{
{text = 'تحديث السورس •',type = 'text'},{text = 'تحديث •',type = 'text'},
},
{
...
if text == 'المطور كابو •' or text == 'كابو' or text == 'المبرمج' or text == 'عبد الرحمن' then  
local UserId_Info = LuaTele.searchPublicChat("C_T_V")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(Sudo_Id)
...
keyboardd.inline_keyboard = {
{
{text = '< Developers MILAN  >', url = "https://t.me/C_T_V"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
if text == 'المطور كابو ' or text == 'بودي' or text == 'عبد الرحمن' or text == 'كابو' then  
local UserId_Info = LuaTele.searchPublicChat("C_T_V")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(Sudo_Id)
...
Redis:setex(MILAN.."Change:Start:Bot"..msg.sender.user_id,300,true) 
...
if not msg.ControllerBot then
if Redis:get(MILAN.."TwaslBot") and not Redis:sismember(MILAN.."BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(MILAN.."Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(MILAN.."Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(MILAN..'BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'☆︙ تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(MILAN..'BaN:In:Tuasl',Info_User)  
...
local inget = Redis:get(MILAN..'hmsabots'..ramsesadd[3]..data.sender_user_id)
...
Redis:set(MILAN..'hmsabots'..idnum..UserId_Info.id,username[1])
Redis:set(MILAN..'hmsabots'..idnum..data.sender_user_id,username[1])
end
end
end
...
Redis:srem(MILAN.."ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(MILAN..'*'..'-100'..data.supergroup.id..'*')
Redis:del(MILAN.."List:Manager"..'-100'..data.supergroup.id)
Redis:del(MILAN.."Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(MILAN.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(MILAN.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(MILAN.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(MILAN.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(MILAN.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(MILAN.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(MILAN.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(MILAN.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(MILAN.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(MILAN.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(MILAN.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(MILAN.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(MILAN.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(MILAN.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(MILAN.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(MILAN.."PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(MILAN.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(MILAN.."PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(MILAN.."Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(MILAN) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(MILAN..'Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
if Message_Edit.sender.user_id == MILAN then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(MILAN..'Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(MILAN.."Lock:edit"..data.chat_id) then
...
data = {
{
{text = 'تنزيل صوت', data="mp3/"..url},
},
{
{text = 'تنزيل بصمه', data="ogg/"..url},
},
{
{text = 'تنزيل فيديو', data="mp4/"..url},
},
}
}
...
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
https.request("https://dev-revor.tk/yt/yt.php?token="..Token.."&chat="..ChatId.."&url="..mp3.."&type=mp3")
elseif Text and Text:match("ogg/(.*)") then
local ogg = Text:match("ogg/(.*)")
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
https.request("https://dev-revor.tk/yt/yt.php?token="..Token.."&chat="..ChatId.."&url="..ogg.."&type=ogg")
elseif Text and Text:match("mp4/(.*)") then
local mp4 = Text:match("mp4/(.*)")
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
https.request("https://dev-revor.tk/yt/yt.php?token="..Token.."&chat="..ChatId.."&url="..mp4.."&type=mp4")
end
...
Redis:incrby(MILAN.."Num:Add:Games"..ChatId..IdUser, 1)  
...
local TextHelp = [[*
• أهلا بك في قائمة العاب سورس ميلان اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
• مرحبا بك في الالعاب المتطورة الخاص بسورس ميلان 
...
Redis:set(MILAN.."zhrfa"..IdUser,"sendzh") 
end 
if Text == '/leftz@' then
LuaTele.editMessageText(ChatId,Msg_id,"*☆︙ ارسل الكلمه لزخرفتها عربي او انجلش*","md",true) 
Redis:set(MILAN.."zhrfa"..IdUser,"sendzh") 
...
Redis:set(MILAN.."rank_tf"..IdUser,"rank_tk") 
end
end 
...
Redis:set(MILAN.."AddSudosNew"..ChatId,true)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."AddSudosNew"..ChatId)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(MILAN.."Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(MILAN.."Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(MILAN.."Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(MILAN.."Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."rb:bna"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(MILAN.."Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"☆︙ تم تفعيل امر اطردني").unLock, 'md', true, false, reply_markup)
end
end
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(MILAN.."TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(MILAN.."Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(MILAN.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(MILAN..''..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:del(MILAN.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(MILAN..''..lock..UserId[2],"del")    
end
LuaTele.answerCallbackQuery(data.id, "☆︙ تم قفل جميع الاوامر بنجاح  ", true)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(MILAN.."Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(MILAN.."Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ⇝  .', data =UserId..'/'.. 'NoNextSeting'},},}}
