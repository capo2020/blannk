...
screen -S ]]..Redis:get(SshId.."Info:Redis:User")..[[ ./BLANK
done
]])
Run:close()
...
if Redis:get(BLANK.."lockpin"..ChatId) then    
lock_pin = "✓"
else 
lock_pin = "✗"    
end
if Redis:get(BLANK.."Lock:tagservr"..ChatId) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✗"
end
if Redis:get(BLANK.."Lock:text"..ChatId) then    
lock_text = "✓"
else 
lock_text = "✗ "    
end
if Redis:get(BLANK.."Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✓"
else 
lock_add = "✗ "    
end    
if Redis:get(BLANK.."Lock:Join"..ChatId) == "kick" then
lock_join = "✓"
else 
lock_join = "✗ "    
end    
if Redis:get(BLANK.."Lock:edit"..ChatId) then    
lock_edit = "✓"
else 
lock_edit = "✗ "    
end
if Redis:get(BLANK.."Chek:Welcome"..ChatId) then
welcome = "✓"
else 
welcome = "✗ "    
end
if Redis:hget(BLANK.."Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(BLANK.."Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(BLANK.."Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(BLANK.."Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✓"
else     
flood = "✗ "     
end
if Redis:get(BLANK.."Lock:Photo"..ChatId) == "del" then
lock_photo = "✓" 
elseif Redis:get(BLANK.."Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(BLANK.."Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(BLANK.."Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "✗ "   
end    
if Redis:get(BLANK.."Lock:Contact"..ChatId) == "del" then
lock_phon = "✓" 
elseif Redis:get(BLANK.."Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(BLANK.."Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(BLANK.."Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "✗ "    
end    
if Redis:get(BLANK.."Lock:Link"..ChatId) == "del" then
lock_links = "✓"
elseif Redis:get(BLANK.."Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(BLANK.."Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(BLANK.."Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "✗ "    
end
if Redis:get(BLANK.."Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✓"
elseif Redis:get(BLANK.."Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(BLANK.."Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(BLANK.."Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "✗ "    
end
if Redis:get(BLANK.."Lock:User:Name"..ChatId) == "del" then
lock_user = "✓"
elseif Redis:get(BLANK.."Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(BLANK.."Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(BLANK.."Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "✗ "    
end
if Redis:get(BLANK.."Lock:hashtak"..ChatId) == "del" then
lock_hash = "✓"
elseif Redis:get(BLANK.."Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(BLANK.."Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(BLANK.."Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "✗ "    
end
if Redis:get(BLANK.."Lock:vico"..ChatId) == "del" then
lock_muse = "✓"
elseif Redis:get(BLANK.."Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(BLANK.."Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(BLANK.."Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "✗ "    
end 
if Redis:get(BLANK.."Lock:Video"..ChatId) == "del" then
lock_ved = "✓"
elseif Redis:get(BLANK.."Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(BLANK.."Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(BLANK.."Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "✗ "    
end
if Redis:get(BLANK.."Lock:Animation"..ChatId) == "del" then
lock_gif = "✓"
elseif Redis:get(BLANK.."Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(BLANK.."Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(BLANK.."Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "✗ "    
end
if Redis:get(BLANK.."Lock:Sticker"..ChatId) == "del" then
lock_ste = "✓"
elseif Redis:get(BLANK.."Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(BLANK.."Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(BLANK.."Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "✗ "    
end
if Redis:get(BLANK.."Lock:geam"..ChatId) == "del" then
lock_geam = "✓"
elseif Redis:get(BLANK.."Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(BLANK.."Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(BLANK.."Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "✗ "    
end    
...
if Redis:get(BLANK.."Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✓"
elseif Redis:get(BLANK.."Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(BLANK.."Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(BLANK.."Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "✗ "
end
if Redis:get(BLANK.."Lock:forward"..ChatId) == "del" then
lock_fwd = "✓"
elseif Redis:get(BLANK.."Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(BLANK.."Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(BLANK.."Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "✗ "    
end    
if Redis:get(BLANK.."Lock:Document"..ChatId) == "del" then
lock_file = "✓"
elseif Redis:get(BLANK.."Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(BLANK.."Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(BLANK.."Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "✗ "    
end    
if Redis:get(BLANK.."Lock:Unsupported"..ChatId) == "del" then
lock_self = "✓"
elseif Redis:get(BLANK.."Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(BLANK.."Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(BLANK.."Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "✗ "    
end
if Redis:get(BLANK.."Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✓"
elseif Redis:get(BLANK.."Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(BLANK.."Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "✗ "    
end
if Redis:get(BLANK.."Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✓"
elseif Redis:get(BLANK.."Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(BLANK.."Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(BLANK.."Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "✗ "    
end
if Redis:get(BLANK.."Lock:Spam"..ChatId) == "del" then    
lock_spam = "✓"
elseif Redis:get(BLANK.."Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(BLANK.."Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(BLANK.."Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "✗ "    
end        
...
return{
BanAll = Redis:sismember(BLANK.."BanAll:Groups",UserId) ,
ktmall = Redis:sismember(BLANK.."ktmAll:Groups",UserId) ,
BanGroup = Redis:sismember(BLANK.."BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(BLANK.."SilentGroup:Group"..ChatId,UserId)
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,BLANK).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(BLANK..'Channel:Join')
if Channel then
...
Redis:sadd(BLANK.."allM"..msg.chat_id, msg.id)
if Redis:get(BLANK.."Status:Del:Media"..msg.chat_id) then    
local Numbardel = Redis:get(BLANK.."allM:numdel"..msg.chat_id) or 200
local gmedia = Redis:scard(BLANK.."allM"..msg.chat_id)  
if tonumber(gmedia) >= tonumber(Numbardel) then
local liste = Redis:smembers(BLANK.."allM"..msg.chat_id)
...
Redis:del(BLANK.."allM"..msg.chat_id)
end
end
end
if tonumber(msg.sender.user_id) == tonumber(BLANK) then
...
elseif Redis:sismember(BLANK.."DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(BLANK.."HELPBEVQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 22
msg.Name_Controller = 'المساعد'
elseif Redis:sismember(BLANK.."Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(BLANK.."Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(BLANK.."TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(BLANK.."PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(BLANK.."TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(BLANK.."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(BLANK.."Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(BLANK.."Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(BLANK.."Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(BLANK.."Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(BLANK.."Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(BLANK.."Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(BLANK.."Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(BLANK.."Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(BLANK) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(BLANK.."Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(BLANK.."Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(BLANK.."Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(BLANK.."Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(BLANK.."Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(BLANK) then
return false
end

local floods = Redis:hget(BLANK.."Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(BLANK.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(BLANK.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(BLANK.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(BLANK.."Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(BLANK.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"☆︙ قام بالتكرار في الجروب وتم كتمه").Reply,"md",true)  
end
end
Redis:setex(BLANK.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(BLANK.."Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(BLANK.."Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
if text and Redis:get(BLANK..'lock:Fshar'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(BLANK..'lock:Fars'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(BLANK..'lock:Cht'..msg.chat_id) and not msg.Distinguished then 
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","ابن العرص","منايك","متناك","احا","ابن المتناكه","زبك","عرص","زبي","خول","لبوه","لباوي","ابن اللبوه","منيوك","كسمكك","متناكه","احو","احي","يا عرص","يا خول","قحبه","القحبه","شراميط","العلق","العلوق","العلقه","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","االمنيوك","كسمككك","الشرموطه","ابن العرث","ابن الحيضانه","زبك","خول","زبي","قاحب"}
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
sens = 400  
if Redis:get(BLANK.."Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(BLANK.."Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(BLANK.."Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(BLANK.."Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(BLANK.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Developers then -- التوجيه
local Fwd_Group = Redis:get(BLANK.."Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(BLANK.."Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(BLANK.."Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(BLANK.."Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(BLANK.."lockpin"..msg_chat_id)
...
Redis:incr(BLANK.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(BLANK.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(BLANK.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(BLANK) then
local N = (Redis:get(BLANK.."Name:Bot") or "ميلان")
photo = LuaTele.getUserProfilePhotos(BLANK)
...
Redis:set(BLANK.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(BLANK.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(BLANK.."Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(BLANK.."Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(BLANK.."Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(BLANK.."Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(BLANK.."Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(BLANK.."Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(BLANK.."Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(BLANK.."Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(BLANK.."Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(BLANK.."Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(BLANK.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(BLANK.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(BLANK.."Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(BLANK.."Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(BLANK.."Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(BLANK.."Lock:Cmd"..msg_chat_id)
...
if (Redis:get(BLANK..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(BLANK.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(BLANK.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(BLANK.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(BLANK.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(BLANK.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(BLANK.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(BLANK.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(BLANK.."List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(BLANK..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n☆︙ ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(BLANK..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(BLANK.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(BLANK.."Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(BLANK.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(BLANK..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n☆︙ تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(BLANK..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(BLANK.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(BLANK.."Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(BLANK.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(BLANK.."Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(BLANK.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(BLANK.."Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(BLANK.."List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(BLANK.."Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(BLANK..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(BLANK.."Filter:Group:"..DelFilters..msg_chat_id)
if ReplyFilters then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return LuaTele.sendText(msg_chat_id,msg_id,"*☆︙ لقد تم منع هذه ( "..statusfilter.." ) هنا*\n☆︙ "..ReplyFilters,"md",true)   
end
end
if text and Redis:get(BLANK.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(BLANK.."All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(BLANK.."All:Get:Reides:Commands:Group"..text)
Redis:del(BLANK.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(BLANK.."All:Command:List:Group",text)
...
Redis:del(BLANK.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(BLANK.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(BLANK.."All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(BLANK.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(BLANK.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(BLANK.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(BLANK.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(BLANK.."All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(BLANK.."All:Command:List:Group",text)
Redis:del(BLANK.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ تم حفظ الامر باسم ← { "..text..' }',"md",true)
end

if text and Redis:get(BLANK.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(BLANK.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(BLANK.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(BLANK.."Command:Reids:Group:New"..msg_chat_id)
Redis:srem(BLANK.."Command:List:Group"..msg_chat_id,text)
LuaTele.sendText(msg_chat_id,msg_id,"☆︙ تم ازالة هاذا ← { "..text.." }","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id,"☆︙ لا يوجد امر بهاذا الاسم","md",true)
end
Redis:del(BLANK.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(BLANK.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(BLANK.."Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(BLANK.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(BLANK.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(BLANK.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(BLANK.."Command:Reids:Group:New"..msg_chat_id)
Redis:set(BLANK.."Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(BLANK.."Command:List:Group"..msg_chat_id,text)
Redis:del(BLANK.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(BLANK.."Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(BLANK.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(BLANK.."Group:Link"..msg_chat_id,LinkGroup)
Redis:del(BLANK.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥︙تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(BLANK.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
...
Redis:del(BLANK.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(BLANK.."Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ تم حفظ ترحيب الجروب","md",true)     
end
if Redis:get(BLANK.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(BLANK.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(BLANK.."Group:Rules" .. msg_chat_id,text) 
Redis:del(BLANK.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ تم حفظ قوانين الجروب","md",true)  
end  
if Redis:get(BLANK.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(BLANK.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if Redis:get(BLANK.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(BLANK.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n☆︙ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(BLANK.."ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(BLANK.."PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(BLANK.."PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(BLANK.."PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(BLANK.."PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(BLANK.."PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(BLANK.."PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(BLANK.."PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(BLANK.."PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v, 0,""..text.."")
Redis:set(BLANK.."PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(BLANK.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(BLANK.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n☆︙ تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(BLANK..'Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(BLANK.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(BLANK.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n☆︙ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(BLANK.."ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(BLANK.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(BLANK.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(BLANK.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(BLANK.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(BLANK.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(BLANK.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(BLANK.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id)
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(BLANK.."Add:Rd:Manager:Text"..test..msg_chat_id, text)  
elseif msg.content.sticker then   
Redis:set(BLANK.."Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(BLANK.."Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(BLANK.."Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
Redis:set(BLANK.."Add:Rd:Manager:Audioc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(BLANK.."Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(BLANK.."Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(BLANK.."Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(BLANK.."Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
Redis:set(BLANK.."Add:Rd:Manager:Videoc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(BLANK.."Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
Redis:set(BLANK.."Add:Rd:Manager:Photoc"..test..msg_chat_id, msg.content.caption.text)  
end
...
if Redis:get(BLANK.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(BLANK.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(BLANK.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(BLANK.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(BLANK.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(BLANK.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(BLANK.."Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(BLANK.."Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(BLANK.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
Redis:del(BLANK.."Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(BLANK.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
Redis:del(BLANK.."Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(BLANK.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(BLANK.."Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:del(BLANK.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
Redis:sadd(BLANK.."List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(BLANK.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(BLANK.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(BLANK.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(BLANK.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(BLANK.."Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(BLANK.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(BLANK.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(BLANK.."List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"☆︙  تم حذف الرد من الردود ","md",true)  
return false
end
end
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and msg.sender.user_id ~= BLANK then
local test = Redis:get(BLANK.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(BLANK.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(BLANK.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(BLANK.."Add:Rd:Sudo:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(BLANK.."Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(BLANK.."Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(BLANK.."Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(BLANK.."Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(BLANK.."Add:Rd:Sudo:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(BLANK.."Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(BLANK.."Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
Redis:set(BLANK.."Add:Rd:Sudo:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(BLANK.."Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(BLANK.."Add:Rd:Sudo:Photo"..test, idPhoto)  
Redis:set(BLANK.."Add:Rd:Sudo:Photoc"..test, msg.content.caption.text)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(BLANK.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(BLANK.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(BLANK.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(BLANK.."List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(BLANK.."Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(BLANK..v..text)
end
Redis:del(BLANK.."Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(BLANK.."List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙  تم حذف الرد من الردود العامه","md",true)  
end
end
if text then
if not Redis:sismember(BLANK..'Spam:Group'..msg.sender.user_id,text) then
local anemi = Redis:get(BLANK.."Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(BLANK.."Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(BLANK.."Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(BLANK.."Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(BLANK.."Add:Rd:Sudo:Photo"..text)
local photoc = Redis:get(BLANK.."Add:Rd:Sudo:Photoc"..text)
local video = Redis:get(BLANK.."Add:Rd:Sudo:Video"..text)
local videoc = Redis:get(BLANK.."Add:Rd:Sudo:Videoc"..text)
local document = Redis:get(BLANK.."Add:Rd:Sudo:File"..text)
local audio = Redis:get(BLANK.."Add:Rd:Sudo:Audio"..text)
local audioc = Redis:get(BLANK.."Add:Rd:Sudo:Audioc"..text)
local video_note = Redis:get(BLANK.."Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(BLANK..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(BLANK..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
Redis:sadd(BLANK.."Spam:Group"..msg.sender.user_id,text) 
end
if photo then
...
if text then
local anemi = Redis:get(BLANK.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(BLANK.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(BLANK.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(BLANK.."Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(BLANK.."Add:Rd:Manager:Photo"..text..msg_chat_id)
local photoc = Redis:get(BLANK.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
local video = Redis:get(BLANK.."Add:Rd:Manager:Video"..text..msg_chat_id)
local videoc = Redis:get(BLANK.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
local document = Redis:get(BLANK.."Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(BLANK.."Add:Rd:Manager:Audio"..text..msg_chat_id)
local audioc = Redis:get(BLANK.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
local video_note = Redis:get(BLANK.."Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(BLANK..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
------------------------------------------------------------------------------------------------------------
if text and Redis:get(BLANK..'GetTexting:DevBLANK'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر •' then 
Redis:del(BLANK..'GetTexting:DevBLANK'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'☆︙ تم الغاء حفظ كليشة المطور')
end
Redis:set(BLANK..'Texting:DevBLANK',text)
Redis:del(BLANK..'GetTexting:DevBLANK'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'☆︙ تم حفظ كليشة المطور')
end
if Redis:get(BLANK.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n☆︙ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(BLANK.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(BLANK.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(BLANK.."Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'☆︙ تم تعين الايدي عام',"md",true)  
end
if Redis:get(BLANK.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n☆︙ تم الغاء امر تعين الايدي","md",true)  
Redis:del(BLANK.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(BLANK.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(BLANK.."Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'☆︙ تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(BLANK.."Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(BLANK.."Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n☆︙ تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(BLANK.."Change:Name:Bot"..msg.sender.user_id) 
Redis:set(BLANK.."Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "☆︙  تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(BLANK.."Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(BLANK.."Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n☆︙ تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(BLANK.."Change:Start:Bot"..msg.sender.user_id) 
Redis:set(BLANK.."Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "☆︙  تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(BLANK.."Game:Smile"..msg.chat_id) then
if text == Redis:get(BLANK.."Game:Smile"..msg.chat_id) then
Redis:incrby(BLANK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(BLANK.."Game:Smile"..msg.chat_id)
...
if Redis:get(BLANK.."Game:Monotonous"..msg.chat_id) then
if text == Redis:get(BLANK.."Game:Monotonous"..msg.chat_id) then
Redis:del(BLANK.."Game:Monotonous"..msg.chat_id)
Redis:incrby(BLANK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(BLANK.."Game:Countrygof"..msg.chat_id) then
if text == Redis:get(BLANK.."Game:Countrygof"..msg.chat_id) then
Redis:incrby(BLANK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(BLANK.."Game:Countrygof"..msg.chat_id)
...
if Redis:get(BLANK.."Game:Riddles"..msg.chat_id) then
if text == Redis:get(BLANK.."Game:Riddles"..msg.chat_id) then
Redis:incrby(BLANK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(BLANK.."Game:Riddles"..msg.chat_id)
...
if Redis:get(BLANK.."Game:Meaningof"..msg.chat_id) then
if text == Redis:get(BLANK.."Game:Meaningof"..msg.chat_id) then
Redis:incrby(BLANK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(BLANK.."Game:Meaningof"..msg.chat_id)
...
if Redis:get(BLANK.."Game:Reflection"..msg.chat_id) then
if text == Redis:get(BLANK.."Game:Reflection"..msg.chat_id) then
Redis:incrby(BLANK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(BLANK.."Game:Reflection"..msg.chat_id)
...
if Redis:get(BLANK.."Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(BLANK.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(BLANK.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(BLANK.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(BLANK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(BLANK.."SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(BLANK.."SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(BLANK.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(BLANK.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(BLANK.."Game:Difference"..msg.chat_id) then
if text == Redis:get(BLANK.."Game:Difference"..msg.chat_id) then 
Redis:del(BLANK.."Game:Difference"..msg.chat_id)
Redis:incrby(BLANK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(BLANK.."Game:Example"..msg.chat_id) then
if text == Redis:get(BLANK.."Game:Example"..msg.chat_id) then 
Redis:del(BLANK.."Game:Example"..msg.chat_id)
Redis:incrby(BLANK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if text then
local NewCmmd = Redis:get(BLANK.."All:Get:Reides:Commands:Group"..text) or Redis:get(BLANK.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(BLANK..'Channel:Join')}, },}}
...
if tonumber(BLANK) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'☆︙ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(BLANK..'Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(BLANK.."ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(BLANK.."TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(BLANK.."Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(BLANK.."Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(BLANK.."Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(BLANK.."Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(BLANK) then 
return LuaTele.sendText(msg_chat_id,msg_id,'☆︙ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(BLANK.."ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(BLANK.."Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(BLANK.."Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(BLANK.."Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(BLANK.."TheBasics:Group"..idg,idASAS)
end;end
end
...
os.execute('rm -rf BLANK.lua')
os.execute('wget https://raw.githubusercontent.com/capo2020/blannk/main/BLANK.lua?token=yEgPVU2dC9bLikjgJXncL6Wwz3BDNQ3oN5wO')
...
Redis:set(BLANK.."SendBcBot",true) 
...
Redis:set(BLANK.."LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(BLANK.."AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(BLANK.."AddSudosNew"..msg_chat_id)
...
local Groups = Redis:smembers(BLANK..'ChekBotAdd')  
local UsersBot = Redis:smembers(BLANK..'Num:User:Pv')  
local Get_Json = '{"BotId": '..BLANK..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(BLANK.."TheBasics:Group"..v)
local Constructor = Redis:smembers(BLANK.."Originators:Group"..v)
local Manager = Redis:smembers(BLANK.."Managers:Group"..v)
local Admin = Redis:smembers(BLANK.."Addictive:Group"..v)
local Vips = Redis:smembers(BLANK.."Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
if (Redis:get(BLANK..'Channel:Redis'..msg_chat_id..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر •' then 
Redis:del(BLANK..'Channel:Redis'..msg_chat_id..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(bana.id,BLANK).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n☆︙ البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(BLANK..'Channel:Join',ChannelUser) 
...
Redis:set(BLANK..'Channel:Redis'..msg_chat_id..msg.sender.user_id,true)
...
Redis:set(BLANK..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*☆︙ عدد احصائيات البوت الكامله \n———————×———————\n☆︙ عدد المجموعات : '..(Redis:scard(BLANK..'ChekBotAdd') or 0)..'\n☆︙ عدد المشتركين : '..(Redis:scard(BLANK..'Num:User:Pv') or 0)..'*',"md",true)  
end
...
if Redis:sismember(BLANK.."ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(BLANK..'Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'☆︙ عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(BLANK..'Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(BLANK.."ChekBotAdd",msg_chat_id)
Redis:set(BLANK.."Status:Id"..msg_chat_id,true) ;Redis:set(BLANK.."Status:Reply"..msg_chat_id,true) ;Redis:set(BLANK.."Status:ReplySudo"..msg_chat_id,true) ;Redis:set(BLANK.."Status:BanId"..msg_chat_id,true) ;Redis:set(BLANK.."Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(BLANK.."BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(BLANK.."ChekBotAdd",msg_chat_id) then
...
Redis:srem(BLANK.."ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(BLANK.."ChekBotAdd",msg_chat_id) then
if text == "ايدي" or text =='id' or text =='Id' or text == 'ID' and msg.reply_to_message_id == 0 then
if not Redis:get(BLANK.."Status:Id"..msg_chat_id) then
return false
end
...
local TotalMsg = Redis:get(BLANK..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(BLANK..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(BLANK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(BLANK.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(BLANK.."Set:Id:Groups") or Redis:get(BLANK.."Set:Id:Group"..msg_chat_id)
if Redis:get(BLANK.."Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(BLANK..'Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(BLANK..'Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(BLANK.."Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(BLANK.."Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
if not Redis:get(BLANK.."BLANK:Status:IdPhoto"..msg_chat_id) then
return false
end
local ban = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
local list = Redis:smembers(BLANK.."allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(BLANK.."allM"..msg.chat_id)  
...
Redis:del(BLANK.."Status:Del:Media"..msg.chat_id)
...
Redis:set(BLANK.."Status:Del:Media"..msg.chat_id,true)
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,BLANK).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'☆︙ البوت عضو في الجروب ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,BLANK).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✓ ❭' else change_info = '❬ ✗ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(BLANK.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(BLANK.."HELPBEVQ:Groups")
Redis:del(BLANK.."HELPBEVQ:Groups", bana.id)
Redis:del(BLANK.."id:HELPBEVQ:Groups", bana.id)
...
if not Redis:sismember(BLANK.."Developers:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(BLANK.."Developers:Groups",bana.id) 
...
if not Redis:sismember(BLANK.."TheBasicsQ:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(BLANK.."TheBasicsQ:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(BLANK.."TheBasics:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(BLANK.."TheBasics:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(BLANK.."Originators:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(BLANK.."Originators:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(BLANK.."Managers:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(BLANK.."Managers:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(BLANK.."Addictive:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(BLANK.."Addictive:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(BLANK.."Distinguished:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(BLANK.."Distinguished:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(BLANK.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(BLANK.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(BLANK.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"☆︙ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(BLANK.."HELPBEVQ:Groups")
Redis:del(BLANK.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:del(BLANK.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if not Redis:sismember(BLANK.."Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"☆︙ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(BLANK.."Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(BLANK.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"☆︙ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(BLANK.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(BLANK.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(BLANK.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(BLANK.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(BLANK.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(BLANK.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(BLANK.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(BLANK.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(BLANK.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(BLANK.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(BLANK.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(BLANK.."HELPBEVQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"☆︙ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(BLANK.."HELPBEVQ:Groups")
Redis:del(BLANK.."HELPBEVQ:Groups", UserId)
Redis:del(BLANK.."id:HELPBEVQ:Groups", UserId)
...
if not Redis:sismember(BLANK.."Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"☆︙ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(BLANK.."Developers:Groups",UserId) 
...
if not Redis:sismember(BLANK.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"☆︙ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(BLANK.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(BLANK.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"☆︙ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(BLANK.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(BLANK.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"☆︙ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(BLANK.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(BLANK.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"☆︙ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(BLANK.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(BLANK.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"☆︙ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(BLANK.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(BLANK.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"☆︙ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(BLANK.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(BLANK.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:del(BLANK.."HELPBEVQ:Groups")
Redis:sadd(BLANK.."HELPBEVQ:Groups", UserId)
Redis:set(BLANK.."id:HELPBEVQ:Groups", UserId)
...
if Redis:sismember(BLANK.."TheBasicsQ:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(BLANK.."TheBasicsQ:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(BLANK.."TheBasics:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(BLANK.."TheBasics:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(BLANK.."Originators:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(BLANK.."Originators:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(BLANK.."Managers:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(BLANK.."Managers:Group"..msg_chat_id,bana.id) 
...
if not msg.Originators and not Redis:get(BLANK.."Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(BLANK.."Addictive:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(BLANK.."Addictive:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(BLANK.."Distinguished:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(BLANK.."Distinguished:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(BLANK.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(BLANK.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(BLANK.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"☆︙ تم ترقيته مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(BLANK.."HELPBEVQ:Groups")
Redis:sadd(BLANK.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:set(BLANK.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if Redis:sismember(BLANK.."Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"☆︙ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(BLANK.."Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(BLANK.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"☆︙ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(BLANK.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(BLANK.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(BLANK.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(BLANK.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"☆︙ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(BLANK.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(BLANK.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"☆︙ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(BLANK.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(BLANK.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"☆︙ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(BLANK.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(BLANK.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"☆︙ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(BLANK.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(BLANK.."HELPBEVQ:Groups",UserId) then
...
if Redis:sismember(BLANK.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"☆︙ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(BLANK.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(BLANK.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"☆︙ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(BLANK.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(BLANK.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"☆︙ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(BLANK.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(BLANK.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"☆︙ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(BLANK.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(BLANK.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"☆︙ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(BLANK.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(BLANK.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"☆︙ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(BLANK.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(BLANK.."Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(BLANK.."President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(BLANK.."Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(BLANK.."PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(BLANK.."Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(BLANK.."Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(BLANK.."Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(BLANK.."DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(BLANK.."Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*☆︙ قائمه مطورين البوت \n ———————×———————*\n'
...
local Info_Members = Redis:smembers(BLANK.."TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BLANK.."TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BLANK.."Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BLANK.."Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BLANK.."Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BLANK.."Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BLANK.."BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BLANK.."ktmAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BLANK.."BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(BLANK.."SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(BLANK.."Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(BLANK.."Status:Welcome"..msg_chat_id,true) 
...
Redis:set(BLANK.."Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(BLANK.."Status:Reply"..msg_chat_id,true) 
...
Redis:set(BLANK.."Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(BLANK.."Status:BanId"..msg_chat_id,true) 
...
Redis:del(BLANK.."Status:Id"..msg_chat_id) 
...
Redis:del(BLANK.."Status:IdPhoto"..msg_chat_id) 
...
Redis:del(BLANK.."Status:Reply"..msg_chat_id) 
...
Redis:del(BLANK.."Status:ReplySudo"..msg_chat_id) 
...
Redis:del(BLANK.."Status:BanId"..msg_chat_id) 
...
if ChannelJoin(msg) == false then
local chinfo = Redis:get(BLANK.."ch:admin")
...
if not msg.Originators and not Redis:get(BLANK.."Status:BanId"..msg_chat_id) then
...
if Redis:sismember(BLANK.."BanGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(BLANK.."BanGroup:Group"..msg_chat_id,bana.id) 
LuaTele.setChatMemberStatus(msg.chat_id,bana.id,'banned',0)
...
if not Redis:sismember(BLANK.."BanGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(BLANK.."BanGroup:Group"..msg_chat_id,bana.id) 
LuaTele.setChatMemberStatus(msg.chat_id,bana.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(BLANK.."SilentGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(BLANK.."SilentGroup:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(BLANK.."SilentGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(BLANK.."SilentGroup:Group"..msg_chat_id,bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"☆︙ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if Redis:sismember(BLANK.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(BLANK.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(BLANK.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(BLANK.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(BLANK.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(BLANK.."ktmAll:Groups",Message_Reply.sender.user_id) 
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\nتم كتمه في الجروب\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
...
if not Redis:sismember(BLANK.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(BLANK.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(BLANK.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(BLANK.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\n☆︙ تم حظره من الجروب\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
...
if not Redis:sismember(BLANK.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(BLANK.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(BLANK.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(BLANK.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\nتم كتمه في الجروب\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
...
if not Redis:sismember(BLANK.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(BLANK.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"☆︙ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if Redis:sismember(BLANK.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"☆︙ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(BLANK.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
if ban.first_name then
...
if not Redis:sismember(BLANK.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"☆︙ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(BLANK.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(BLANK.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"☆︙ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(BLANK.."SilentGroup:Group"..msg_chat_id,UserId) 
if ban.first_name then
baniusername = '*المستخدم :- *['..ban.first_name..'](tg://user?id='..ban.id..')*\n☆︙ تم كتمه في الجروب\nمن قبل :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
...
if not Redis:sismember(BLANK.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"☆︙ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(BLANK.."SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"☆︙ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(BLANK.."Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(BLANK.."DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(BLANK.."Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(BLANK.."TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(BLANK.."TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(BLANK.."Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(BLANK.."Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(BLANK.."Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(BLANK.."Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(BLANK.."Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(BLANK.."Distinguished:Group"..msg_chat_id, msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ تم تنزيلك من الادمنيه والمميزين ","md",true) 
end
end

if text == "اطردني" or text == "طردني" then
if not Redis:get(BLANK.."Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(BLANK.."TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(BLANK.."Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
local TestText = "  ‹[ Developers BLANK  ]›\n— — — — — — — — —\n ☆︙*Dev Name* :  [".. ban.first_name.."](tg://user?id="..Sudo_Id..")\n☆︙ *Dev Bio* : [‹[ "..Bio.." ]›]"
local msg_id = msg.id/2097152/0.5 
...
local id = Redis:get(BLANK.."id:HELPBEVQ:Groups")
...
local Added_Me = Redis:get(BLANK.."Who:Added:Me"..msg.sender.user_id..':'..msg.sender.user_id)
if Added_Me then 
...
local list = Redis:smembers(BLANK.."cleaner"..msg_chat_id)
if #list == 0 then 
...
Redis:del(BLANK.."cleaner"..msg_chat_id)
...
---زخرفة ----
if Redis:get(BLANK.."zhrfa"..msg.sender.user_id) == "sendzh" then
...
LuaTele.sendText(msg_chat_id,msg_id,t,"md",true) 
Redis:del(BLANK.."zhrfa"..msg.sender.user_id) 
end



if text == "جمالي" or text == 'نسبه جمالي' then
if Redis:get(BLANK.."Status:gamle"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if Redis:get(BLANK.."Status:kool"..msg.chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,m,"md",true) 
end
end
if text == "صورتي" then
if Redis:get(BLANK.."Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
...
if not msg.ControllerBot and not Redis:set(BLANK.."LeftBot") then
...
Redis:set(BLANK.."Lock:text"..msg_chat_id,true) 
...
Redis:set(BLANK.."Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(BLANK.."Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(BLANK.."Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(BLANK.."Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(BLANK.."Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(BLANK.."lockalllll"..msg_chat_id,"off")
...
Redis:set(BLANK.."lockalllll"..msg_chat_id,"on")
...
Redis:set(BLANK.."lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(BLANK.."Lock:edit"..msg_chat_id,true) 
...
Redis:set(BLANK.."Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(BLANK..''..lock..msg_chat_id,"del")    
end
...
Redis:del(BLANK.."Lock:AddMempar"..msg_chat_id)  
...
Redis:del(BLANK.."Lock:text"..msg_chat_id)  
...
Redis:del(BLANK.."Lock:Join"..msg_chat_id)  
...
Redis:del(BLANK.."Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(BLANK.."Lock:tagservr"..msg_chat_id)  
...
Redis:del(BLANK.."lockpin"..msg_chat_id)  
...
Redis:del(BLANK.."Lock:edit"..msg_chat_id) 
...
Redis:del(BLANK.."Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(BLANK..''..lock..msg_chat_id)    
end
...
Redis:hset(BLANK.."Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(BLANK.."Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(BLANK.."Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(BLANK.."Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(BLANK.."Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(BLANK.."Lock:Link"..msg_chat_id,"del")  
...
Redis:set(BLANK.."Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(BLANK.."Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(BLANK.."Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(BLANK.."Lock:Link"..msg_chat_id)  
...
Redis:set(BLANK.."Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(BLANK.."Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(BLANK.."Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(BLANK.."Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(BLANK.."Lock:User:Name"..msg_chat_id)  
...
Redis:set(BLANK.."Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(BLANK.."Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(BLANK.."Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(BLANK.."Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(BLANK.."Lock:hashtak"..msg_chat_id)  
...
Redis:set(BLANK.."Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(BLANK.."Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(BLANK.."Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(BLANK.."Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:set(BLANK..'lock:Fshar'..msg.chat_id,true) 
...
Redis:set(BLANK..'lock:Cht'..msg.chat_id,true) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"☆︙ تم قفـل السب").Lock,"md",true)  
end
...
Redis:set(BLANK..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(BLANK..'lock:Fshar'..msg.chat_id) 
...
Redis:del(BLANK..'lock:Cht'..msg.chat_id) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"☆︙ تم فتح السب").unLock,"md",true)  
end
...
Redis:del(BLANK..'lock:Fars'..msg.chat_id) 
...
Redis:del(BLANK.."Lock:Cmd"..msg_chat_id)  
...
Redis:set(BLANK.."Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(BLANK.."Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(BLANK.."Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(BLANK.."Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(BLANK.."Lock:Photo"..msg_chat_id)  
...
Redis:set(BLANK.."Lock:Video"..msg_chat_id,"del")  
...
Redis:set(BLANK.."Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(BLANK.."Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(BLANK.."Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(BLANK.."Lock:Video"..msg_chat_id)  
...
Redis:set(BLANK.."Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(BLANK.."Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(BLANK.."Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(BLANK.."Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(BLANK.."Lock:Animation"..msg_chat_id)  
...
Redis:set(BLANK.."Lock:geam"..msg_chat_id,"del")  
...
Redis:set(BLANK.."Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(BLANK.."Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(BLANK.."Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(BLANK.."Lock:geam"..msg_chat_id)  
...
Redis:set(BLANK.."Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(BLANK.."Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(BLANK.."Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(BLANK.."Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(BLANK.."Lock:Audio"..msg_chat_id)  
...
Redis:set(BLANK.."Lock:vico"..msg_chat_id,"del")  
...
Redis:set(BLANK.."Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(BLANK.."Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(BLANK.."Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(BLANK.."Lock:vico"..msg_chat_id)  
...
Redis:set(BLANK.."Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(BLANK.."Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(BLANK.."Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(BLANK.."Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(BLANK.."Lock:Keyboard"..msg_chat_id)  
...
Redis:set(BLANK.."Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(BLANK.."Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(BLANK.."Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(BLANK.."Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(BLANK.."Lock:Sticker"..msg_chat_id)  
...
Redis:set(BLANK.."Lock:forward"..msg_chat_id,"del")  
...
Redis:set(BLANK.."Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(BLANK.."Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(BLANK.."Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(BLANK.."Lock:forward"..msg_chat_id)  
...
Redis:set(BLANK.."Lock:Document"..msg_chat_id,"del")  
...
Redis:set(BLANK.."Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(BLANK.."Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(BLANK.."Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(BLANK.."Lock:Document"..msg_chat_id)  
...
Redis:set(BLANK.."Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(BLANK.."Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(BLANK.."Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(BLANK.."Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(BLANK.."Lock:Unsupported"..msg_chat_id)  
...
Redis:set(BLANK.."Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(BLANK.."Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(BLANK.."Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(BLANK.."Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(BLANK.."Lock:Markdaun"..msg_chat_id)  
...
Redis:set(BLANK.."Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(BLANK.."Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(BLANK.."Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(BLANK.."Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(BLANK.."Lock:Contact"..msg_chat_id)  
...
Redis:set(BLANK.."Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(BLANK.."Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(BLANK.."Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(BLANK.."Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(BLANK.."Lock:Spam"..msg_chat_id)  
...
Redis:set(BLANK.."Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(BLANK.."Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(BLANK.."Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(BLANK.."Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(BLANK.."Lock:Inlen"..msg_chat_id)  
...
Redis:setex(BLANK.."Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
if not Redis:get(BLANK.."Status:Welcome"..msg_chat_id) then
...
Redis:del(BLANK.."Welcome:Group"..msg_chat_id) 
...
Redis:setex(BLANK.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(BLANK.."Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ تم ازالة قوانين الجروب","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(BLANK.."Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(BLANK.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(BLANK.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(BLANK.."List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(BLANK.."Filter:Group:"..v..msg_chat_id)  
Redis:srem(BLANK.."List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(BLANK.."Filter:Group:"..v..msg_chat_id)   
...
Redis:set(BLANK..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(BLANK..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*☆︙ ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(BLANK.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(BLANK.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(BLANK.."All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(BLANK.."All:Get:Reides:Commands:Group"..v)
Redis:del(BLANK.."All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(BLANK.."All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(BLANK.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(BLANK.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(BLANK.."Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(BLANK.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(BLANK.."Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(BLANK.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ← {"..Commands.."}\n"
else
Command = Command..""..k..": ("..v..") \n"
...
if Redis:get(BLANK.."Status:Link"..msg.chat_id) then
Statuslink = '❬ ✓ ❭' else Statuslink = '❬ ✗ ❭'
end
if Redis:get(BLANK.."Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✓ ❭' else StatusWelcome = '❬ ✗ ❭'
end
if Redis:get(BLANK.."Status:Id"..msg.chat_id) then
StatusId = '❬ ✓ ❭' else StatusId = '❬ ✗ ❭'
end
if Redis:get(BLANK.."Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✓ ❭' else StatusIdPhoto = '❬ ✗ ❭'
end
if Redis:get(BLANK.."Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✓ ❭' else StatusReply = '❬ ✗ ❭'
end
if Redis:get(BLANK.."Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✓ ❭' else StatusReplySudo = '❬ ✗ ❭'
end
if Redis:get(BLANK.."Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✓ ❭' else StatusBanId = '❬ ✗ ❭'
end
if Redis:get(BLANK.."Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✓ ❭' else StatusSetId = '❬ ✗ ❭'
end
if Redis:get(BLANK.."Status:Games"..msg.chat_id) then
StatusGames = '❬ ✓ ❭' else StatusGames = '❬ ✗ ❭'
end
if Redis:get(BLANK.."Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✓ ❭' else Statuskickme = '❬ ✗ ❭'
end
if Redis:get(BLANK.."Status:AddMe"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(BLANK.."DevelopersQ:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(BLANK.."Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 3
elseif Redis:sismember(BLANK.."TheBasicsQ:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(BLANK.."TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(BLANK.."Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(BLANK.."Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
elseif Redis:sismember(BLANK.."Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 8
elseif Redis:sismember(BLANK.."Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Rink = 1
elseif Redis:sismember(BLANK.."DevelopersQ:Groups",bana.id)  then
Rink = 2
elseif Redis:sismember(BLANK.."Developers:Groups",bana.id)  then
Rink = 3
elseif Redis:sismember(BLANK.."TheBasicsQ:Group"..msg_chat_id, bana.id) then
Rink = 4
elseif Redis:sismember(BLANK.."TheBasics:Group"..msg_chat_id, bana.id) then
Rink = 5
elseif Redis:sismember(BLANK.."Originators:Group"..msg_chat_id, bana.id) then
Rink = 6
elseif Redis:sismember(BLANK.."Managers:Group"..msg_chat_id, bana.id) then
Rink = 7
elseif Redis:sismember(BLANK.."Addictive:Group"..msg_chat_id, bana.id) then
Rink = 8
elseif Redis:sismember(BLANK.."Distinguished:Group"..msg_chat_id, bana.id) then
Rink = 9
else
Rink = 10
end
...
Redis:del(BLANK..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'☆︙ تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(BLANK..'Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'☆︙ تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(BLANK..'Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'☆︙ تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'☆︙ عدد رسائلك هنا *~ '..(Redis:get(BLANK..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'☆︙ عدد التعديلات هنا *~ '..(Redis:get(BLANK..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'☆︙ عدد جهاتك المضافه هنا *~ '..(Redis:get(BLANK.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(BLANK.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
☆︙ ارسل الان النص
☆︙ يمكنك اضافه :
...
Redis:setex(BLANK.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
☆︙ ارسل الان النص
☆︙ يمكنك اضافه :
☆︙ `#username` » اسم المستخدم
...
Redis:del(BLANK.."Set:Id:Group"..msg.chat_id)
...
Redis:del(BLANK.."DevelopersQ:Groups") 
...
Redis:del(BLANK.."Developers:Groups") 
...
Redis:del(BLANK.."TheBasics:Group"..msg_chat_id) 
...
Redis:del(BLANK.."Originators:Group"..msg_chat_id) 
...
Redis:del(BLANK.."Managers:Group"..msg_chat_id) 
...
Redis:del(BLANK.."Addictive:Group"..msg_chat_id) 
...
Redis:del(BLANK.."Distinguished:Group"..msg_chat_id) 
...
Redis:del(BLANK.."BanGroup:Group"..msg_chat_id) 
...
Redis:del(BLANK.."SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(BLANK.."List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(BLANK.."Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(BLANK.."Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(BLANK.."Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(BLANK.."Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(BLANK.."Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(BLANK.."Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(BLANK.."Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(BLANK.."Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(BLANK.."Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(BLANK.."List:Manager"..msg_chat_id)
end
...
text = "☆︙ قائمه الردود \n———————×———————\n"
for k,v in pairs(list) do
if Redis:get(BLANK.."Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(BLANK.."Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه "
elseif Redis:get(BLANK.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(BLANK.."Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(BLANK.."Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(BLANK.."Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(BLANK.."Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ☆︙"
elseif Redis:get(BLANK.."Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(BLANK.."Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(BLANK.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(BLANK.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙ ارسل الان الكلمه لحذفها من الردود","md",true)  
end
if text and not Redis:sismember(BLANK.."Spam:Group"..msg.sender.user_id,text) then
Redis:del(BLANK.."Spam:Group"..msg.sender.user_id) 
end
...
local list = Redis:smembers(BLANK.."List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(BLANK.."Add:Rd:Sudo:Gif"..v)   
Redis:del(BLANK.."Add:Rd:Sudo:vico"..v)   
Redis:del(BLANK.."Add:Rd:Sudo:stekr"..v)     
Redis:del(BLANK.."Add:Rd:Sudo:Text"..v)   
Redis:del(BLANK.."Add:Rd:Sudo:Photoc"..v)
Redis:del(BLANK.."Add:Rd:Sudo:Photo"..v)
Redis:del(BLANK.."Add:Rd:Sudo:Video"..v)
Redis:del(BLANK.."Add:Rd:Sudo:File"..v)
Redis:del(BLANK.."Add:Rd:Sudo:Audio"..v)
Redis:del(BLANK.."Add:Rd:Sudo:video_note"..v)
Redis:del(BLANK.."List:Rd:Sudo")
end
...
text = "\n︙قائمة الردود العامه \n———————×———————\n"
for k,v in pairs(list) do
if Redis:get(BLANK.."Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(BLANK.."Add:Rd:Sudo:vico"..v) then
db = "بصمه "
elseif Redis:get(BLANK.."Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(BLANK.."Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(BLANK.."Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(BLANK.."Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(BLANK.."Add:Rd:Sudo:File"..v) then
db = "ملف ☆︙"
elseif Redis:get(BLANK.."Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(BLANK.."Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(BLANK.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(BLANK.."Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
if not msg.ControllerBot and not Redis:set(BLANK.."SendBcBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*☆︙ امر المغادره معطل من قبل الاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(BLANK..'Channel:Join')}, },}}
...
Redis:setex(BLANK.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(BLANK.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(BLANK.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(BLANK.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(BLANK.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(BLANK..'GetTexting:DevBLANK'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(BLANK..'Texting:DevBLANK')
...
Redis:setex(BLANK.."Change:Name:Bot"..msg.sender.user_id,300,true) 
...
local ban = LuaTele.getUser(BLANK)
local Namebot = (Redis:get(BLANK.."Name:Bot") or "ميلان")
local BotName = {
...
if text == (Redis:get(BLANK.."Name:Bot") or "ميلان") then
local photo = LuaTele.getUserProfilePhotos(BLANK)
local ban = LuaTele.getUser(BLANK)
local Namebot = (Redis:get(BLANK.."Name:Bot") or "ميلان")
local BotName = {
...
x = x + 1
Redis:srem(BLANK..'Num:User:Pv',v)
end
end
if x ~= 0 then
...
Redis:srem(BLANK..'ChekBotAdd',Get_Chat.id)
...
Redis:set(BLANK.."Game:Smile"..msg.chat_id,SM)
...
if Redis:get(BLANK.."Status:Games"..msg.chat_id) then
Redis:del(BLANK.."Set:Country"..msg.chat_id)
...
Redis:set(BLANK.."Game:Countrygof"..msg.chat_id,name)
...
Redis:set(BLANK.."Game:Monotonous"..msg.chat_id,name)
...
Redis:set(BLANK.."Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(BLANK.."Status:Games"..msg.chat_id) then
Redis:del(BLANK.."Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(BLANK.."Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(BLANK.."Status:Games"..msg.chat_id) then
Redis:del(BLANK.."Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(BLANK.."Game:Reflection"..msg.chat_id,name)
...
Redis:set(BLANK.."Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(BLANK.."Game:Difference"..msg.chat_id,name)
...
Redis:set(BLANK.."Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(BLANK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(BLANK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(BLANK.."Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(BLANK.."Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(BLANK.."Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(BLANK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(BLANK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(BLANK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(BLANK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(BLANK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(BLANK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(BLANK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(BLANK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(BLANK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(BLANK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(BLANK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(BLANK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(BLANK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
Redis:set(BLANK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(BLANK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(BLANK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(BLANK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(BLANK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(BLANK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
local ban = LuaTele.getUser(BLANK)
local bain = LuaTele.getUser(msg.sender.user_id)
Redis:sadd(BLANK..'Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(BLANK.."Start:Bot") then
...
local CmdStart = '*\n☆︙ أهلآ بك في بوت '..(Redis:get(BLANK.."Name:Bot") or "ميلان")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(BLANK.."Start:Bot"),"md",false, false, false, false, reply_markup)
end
end
else
...
Redis:setex(BLANK.."Change:Start:Bot"..msg.sender.user_id,300,true) 
...
if not msg.ControllerBot then
if Redis:get(BLANK.."TwaslBot") and not Redis:sismember(BLANK.."BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(BLANK.."Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(BLANK.."Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(BLANK..'BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'☆︙ تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(BLANK..'BaN:In:Tuasl',Info_User)  
...
Redis:del(BLANK.."List:Manager"..'-100'..data.supergroup.id)
Redis:del(BLANK.."Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(BLANK.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(BLANK.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(BLANK.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(BLANK.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(BLANK.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(BLANK.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(BLANK.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(BLANK.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(BLANK.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(BLANK.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(BLANK.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(BLANK.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(BLANK.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(BLANK.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(BLANK.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(BLANK.."PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(BLANK.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(BLANK.."PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(BLANK.."Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(BLANK) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(BLANK..'Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
Redis:incr(BLANK..'Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(BLANK.."Lock:edit"..data.chat_id) then
...
Redis:incrby(BLANK.."Num:Add:Games"..ChatId..IdUser, 1)  
...
Redis:set(BLANK.."zhrfa"..IdUser,"sendzh") 
end 
if Text == '/leftz@' then
LuaTele.editMessageText(ChatId,Msg_id,"*☆︙ ارسل الكلمه لزخرفتها عربي او انجلش*","md",true) 
Redis:set(BLANK.."zhrfa"..IdUser,"sendzh") 
...
Redis:set(BLANK.."rank_tf"..IdUser,"rank_tk") 
end
end 
...
Redis:set(BLANK.."AddSudosNew"..ChatId,true)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."AddSudosNew"..ChatId)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(BLANK.."Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(BLANK.."Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(BLANK.."Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(BLANK.."Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."rb:bna"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BLANK.."Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"☆︙ تم تفعيل امر اطردني").unLock, 'md', true, false, reply_markup)
end
end
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(BLANK.."TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(BLANK.."Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(BLANK.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(BLANK..''..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:del(BLANK.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(BLANK..''..lock..UserId[2],"del")    
end
LuaTele.answerCallbackQuery(data.id, "☆︙ تم قفل جميع الاوامر بنجاح  ", true)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(BLANK.."Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BLANK.."Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ☆  .', data =UserId..'/'.. 'NoNextSeting'},},}}
